...
if __name__ == '__main__':
    ...
    parser.add_argument('--state_dict_path', type=str, default="./U_net-20.pkl", help='path for pre-trained model')
    ...
    parser.add_argument('--valid_path', type=str, default='../test_data')
